...
function LearningOutcome2(){
    ...
    const changeRow = (event,index) =>{
        ...
        setData(newData);
        alert("Change row"+event.target.value );
    }
    ...
    const removeRow = (item)=>{
        ...
        alert("removing row that is "+item.outcome);
        ...
        alert("newDatalength = "+ newData2.length+ " dataLength = " +data.length)
        ...
        //we need to reupdate row numbers!
