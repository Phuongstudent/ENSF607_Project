        ...
        return (
          <header className = "text">
           ...
           <table className="table1">
            ...
            <div>Graduate Attributes are generic characteristics specified by the CEAB (Canadian Engineering Accreditation Board), expected to be exhibited by graduates of Canadian engineering schools. This table summarizes how the Learning Outcomes relate to key Graduate Attributes addressed in this course.</div>
            ...
            <div>CEAB Graduate Attributes</div>
            ...
            <h3>Course Content Categories</h3>
            <div>The following table displays the course content categories and their AU (Accrediation Unit Percentages</div>
